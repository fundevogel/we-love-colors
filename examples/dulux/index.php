...
<html lang="en">
  ...
  <body>
    <?php
        ...
        // See https://www.php.net/manual/en/function.dechex.php#25437
        function RGB2hex(array $color) {
    ...
    <!-- COPYRIGHT NOTICE -->
    <header>
      Dulux® is the property of <a href="https://www.akzonobel.com">AkzoNobel N.V.</a> (dutch joint-stock company).
    </header>
    ...
    <?php
        ...
        $title = ucwords(basename($file, '.json'));
    ?>
        <li>
